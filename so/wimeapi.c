...
/*
  ...
  設定の時成功すればtrue、サーバーが死んでいるときはfalseを返す。
*/
...
/*
  style=WIME_POS_...
  WIME_POS_POINTのときは追加引数にint x,y
  WIME_POS_EXCLUDEのときはさらにint x,y,w,h(l,t,r,bではない)
*/
...
/*
  ...
  通信に失敗したときにfalseを返す。atokがないときはデフォルトの色を返す。
 */
